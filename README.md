...
| `trim`               | Object                     | `{ enabled: false, closeEditor: true }`                                                                                        | `enabled`: Whether to enable the video trimming tool. `closeEditor`: On exit of the trimming tool should the editor be exited.                                                                                                                                                                                                                                                                          |
| `markers`            | Object                     | `{ enabled: false}`                                                                                                            | `enabled`: Whether to enable the video markers tool.                                                                                                                                                                                                                                                                                                                                                    |
