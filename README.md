...
| `markers`            | Object                     | `{ enabled: false, lockToTrimRegion: true}`                                                                                    | `enabled`: Whether to enable the video markers tool. `lockToTrimRegion`: If the trimming region is present prevent adding markers outside of the trimming window                                                                                                                                                                                                                                        |
